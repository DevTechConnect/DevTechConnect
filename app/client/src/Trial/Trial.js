...
const Trial = (props) => {
    return (
        <div>
            <h1>
                Welcome to DevTech Connect. We are happy you're here.
            </h1>
            <p>
            ...
            <button type='button' name='signupTrial' onClick={props.signupClick}>
                    Sign Up
            </button>
            <button type='button' name='htmlTrial' onClick={props.htmlTrialClick}>
                    Try Our HTML Track
            </button>
        </div>
    )
