                            ...
                            <div className='content-box'>
                                ...
                                <div className='vid-holder'>
                                    ...
                                    <Iframe url={this.props.allTracks[this.props.trackId].steps[7].stepLink.replace('watch', 'embed')}
                                            ...
                                            allowFullScreen/>
                                    <br />
                                    <a target='_blank' className='article-link' href={this.props.allTracks[this.props.trackId].steps[7].stepLink}>URL: {this.props.allTracks[this.props.trackId].steps[7].stepLink}</a>
                                    <br />
